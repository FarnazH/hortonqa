...
def test_ap1rog_cs():
    ...
    energy, g = geminal_solver(
        one, er, external['nn'], exp_alpha, olp, False, **{'guess': {'geminal': guess}})
...
def test_ap1rog_cs_scf():
    ...
    energy, g, l = geminal_solver(
        one, er, external['nn'], exp_alpha, olp, True, **{'checkpoint': -1, 'guess': {'geminal': guess}})
